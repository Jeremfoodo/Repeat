...
def segmentation_page(df):
    ...
    inactive_clients['Info Client'] = inactive_clients.apply(lambda row: f'<a href="/?client_id={row["Restaurant ID"]}" target="_self">Voir Info</a>', axis=1)
    st.write(inactive_clients[['Restaurant ID', 'Restaurant', 'Segment', 'Spending Level', 'Total', 'Dernière commande', 'Info Client']], unsafe_allow_html=True)
    ...
    downgraded_clients['Info Client'] = downgraded_clients.apply(lambda row: f'<a href="/?client_id={row["Restaurant ID"]}" target="_self">Voir Info</a>', axis=1)
    st.write(downgraded_clients[['Restaurant ID', 'Restaurant_Juin', 'Spending Level_Juin', 'Total_Juin', 'Spending Level_Juillet', 'Total_Juillet', 'Dernière commande', 'Info Client']], unsafe_allow_html=True)
    ...
    same_tier_less_spending_clients['Info Client'] = same_tier_less_spending_clients.apply(lambda row: f'<a href="/?client_id={row["Restaurant ID"]}" target="_self">Voir Info</a>', axis=1)
    st.write(same_tier_less_spending_clients[['Restaurant ID', 'Restaurant_Juin', 'Spending Level_Juin', 'Total_Juin', 'Total_Juillet', 'Dernière commande', 'Info Client']], unsafe_allow_html=True)
    ...
    increased_spending_clients['Info Client'] = increased_spending_clients.apply(lambda row: f'<a href="/?client_id={row["Restaurant ID"]}" target="_self">Voir Info</a>', axis=1)
    st.write(increased_spending_clients[['Restaurant ID', 'Restaurant_Juin', 'Spending Level_Juin', 'Total_Juin', 'Total_Juillet', 'Dernière commande', 'Info Client']], unsafe_allow_html=True)
